...
<html>
	...
	<div><?php
		if($_GET['update'] == 'nightly'){
		    ...
		    $zip->addEmptyDir('images/backgrounds');
		    $zip->addFromString('images/backgrounds/top.png', file_get_contents("https://twbbler.googlecode.com/svn/trunk/images/backgrounds/top.png"));
