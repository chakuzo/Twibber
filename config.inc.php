<?php
/**
 * Fill out the Data to the connection. Haha Git Test
 */
...
define("wcf_dir", "/wcf"); // The dir where the wcf ordner is. For example "example.com/wcf", so write "/wcf". NO TRAILING SLASH !!!
