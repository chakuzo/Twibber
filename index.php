...
<html>
    ...
    <body>
	<header><?php if(!$return){ ?><a href="login.php"><img src="res/img/buttons/login.png" alt="Login"></a><?php }else{ ?>Hallo, <?=$_COOKIE['twibber_nick']?>. <a href="">Ausloggen</a> <?php } ?><a href="http://wbblite2.de"><img src="res/img/buttons/wbblite2.png" alt="WBBLite2.de"></a></header>
